                                ...
                                <div key={index} className="card" style={{ width: "18rem", flexShrink: 0 }}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <button className="btn btn-light" onClick={() => handleFavorite(character)}>
                                ...
                                <div key={index} className="card" style={{ width: "18rem", flexShrink: 0 }}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <button className="btn btn-light" onClick={() => handleFavorite(planet)}>
                                                <i className="fas fa-heart text-danger"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div key={index} className="card" style={{ width: "18rem", flexShrink: 0 }}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <button className="btn btn-light" onClick={() => handleFavorite(vehicle)}>
                                                <i className="fas fa-heart text-danger"></i>
                                            </button>
                                        </div>
                                    </div>
